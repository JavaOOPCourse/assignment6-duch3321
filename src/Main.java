...
public class Main {
    public static void main(String[] args) {
        ...
        students.put("111",new Student("Nurdan",2.2,18));
        students.put("222",new Student("Adel",3.0,19));
        students.put("333",new Student("Belek",3.3,20));
        students.put("444",new Student("Erbol",3.3,20));
        students.put("555",new Student("Roman",2.2,18));
